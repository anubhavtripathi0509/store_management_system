...
class StoreManagementSystem:
    def __init__(self, root):
        ...
        newOrder_btn=Button(btn_frame, text="NEW ORDER",width=22, command=self.order_details, font=("times new roman", 14,"bold"), bg="black", fg="gold", bd=0, cursor="hand2")
        ...
        logout_btn=Button(btn_frame, text="LOGOUT",width=22, command=self.logout, font=("times new roman", 14,"bold"), bg="black", fg="gold", bd=0, cursor="hand2")
